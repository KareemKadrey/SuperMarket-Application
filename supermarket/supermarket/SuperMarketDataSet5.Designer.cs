...
namespace supermarket.SuperMarketDataSet5TableAdapters {
    ...
    public partial class CUSTOMERTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[CUSTOMER] WHERE (([customer_id] = @Original_customer_id) AND (" +
                "[username] = @Original_username) AND ([address] = @Original_address) AND ([phone" +
                "] = @Original_phone))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[CUSTOMER] SET [username] = @username, [address] = @address, [phone] = @phone WHERE (([customer_id] = @Original_customer_id) AND ([username] = @Original_username) AND ([address] = @Original_address) AND ([phone] = @Original_phone));
SELECT customer_id, username, address, phone FROM CUSTOMER WHERE (customer_id = @customer_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT customer_id, username, address, phone FROM dbo.CUSTOMER";
        ...
        public virtual int Fill(SuperMarketDataSet5.CUSTOMERDataTable dataTable) {
        ...
        public virtual SuperMarketDataSet5.CUSTOMERDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            SuperMarketDataSet5.CUSTOMERDataTable dataTable = new SuperMarketDataSet5.CUSTOMERDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(SuperMarketDataSet5.CUSTOMERDataTable dataTable) {
        ...
        public virtual int Delete(int Original_customer_id, string Original_username, string Original_address, string Original_phone) {
        ...
        public virtual int Update(string username, string address, string phone, int Original_customer_id, string Original_username, string Original_address, string Original_phone, int customer_id) {
            if ((username == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string username, string address, string phone, int Original_customer_id, string Original_username, string Original_address, string Original_phone) {
            return this.Update(username, address, phone, Original_customer_id, Original_username, Original_address, Original_phone, Original_customer_id);
        }
    }
